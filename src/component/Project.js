    ...
    <section id="projects" className="py-4 text-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center gap-10">
          <div className="w-full md:w-[45%] relative group overflow-hidden rounded-2xl shadow-lg">
            <img
              src={herds}
              alt="Project 1"
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center 
                            bg-purple-600/70 opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out">
              <h5 className="text-2xl font-bold mb-3 bg-transparent text-white">Project 1</h5>
          ...
          <div className="w-full md:w-[45%] relative group overflow-hidden rounded-2xl shadow-lg">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center 
                            bg-red-600/70 opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out">
              <h5 className="text-2xl font-bold mb-3 bg-transparent text-white">Project 2</h5>
